...
namespace Theme {
    const juce::Colour primaryColor(0xFF51DD9Au);
    const juce::Colour secondaryColor(0xFFFFFFFu);
    const juce::Colour bgColor(0xFF0F1326u);
    const juce::Colour bgOutlineColor(0xFF302044u);
    const float fontSizeh1 = 36;
